...
public class EjbConsumidorT_Alternativo implements MessageListener {

    @Override
    public void onMessage(Message msg) {
        // Quando receber exibe console do servidor (qual consumidor receber)
        System.out.println("(topico alterntivo) Mensagem recebida pelo: " + this.getClass().getSimpleName());
        try {
