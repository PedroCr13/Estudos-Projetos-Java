...
public class Abastecimento implements Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        return veiculo == that.veiculo && posto == that.posto &&
                Double.compare(kmAtual, that.kmAtual) == 0 &&
                qtdLitros == that.qtdLitros &&
                Double.compare(valorPago, that.valorPago) == 0 &&
                calibrouPneus == that.calibrouPneus &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(data, veiculo, posto, kmAtual, combustivel, qtdLitros, valorPago, calibrouPneus);
    }
